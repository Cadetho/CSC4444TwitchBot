...
class Chatbot:
    ...
    class TestMode:
        ...
        TWITCH = 'twitch' # twitch mode (users can ask the chatbot on twitch and get replies back)
    ...
    def parseArgs(args):
        ...
        globalArgs.add_argument('--test',
                                nargs='?',
                                choices=[Chatbot.TestMode.ALL, Chatbot.TestMode.INTERACTIVE, Chatbot.TestMode.DAEMON, Chatbot.TestMode.TWITCH],
    ...
    def main(self, args=None):
        ...
        if self.args.test:
            ...
            elif self.args.test == Chatbot.TestMode.TWITCH:
                self.mainTestTwitch(self.sess)
            else:
    ...
    def mainTestInteractive(self, sess):
        ...
        while True:
            ...
            #print(self.textData.sequence2str(answer, clean=True))
    ...
    def mainTestTwitch(self, sess):
        ...
        readbuffer = ""
        s = twitchbot.openSocket()
        twitchbot.joinRoom(s)
